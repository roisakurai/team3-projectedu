...
import (
	...
	"progress-service/internal/consumer"
	"progress-service/internal/handler"
	appMiddleware "progress-service/internal/middleware"
...
func main() {
	...
	// ─── Redis ────────────────────────────────────────────────────────────────
	redisClient := redispkg.NewClient(cfg.RedisAddr, cfg.RedisPassword, cfg.RedisDB)
