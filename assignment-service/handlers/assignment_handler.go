...
// @Produce json
// @Security BearerAuth
// @Param request body models.CreateAssignmentRequest true "Create Assignment"
...
// @Security BearerAuth
// @Param id path string true "Assignment ID"
// @Param request body models.UpdateAssignmentRequest true "Update Assignment"
// @Success 200 {object} map[string]interface{}
...
// @Security BearerAuth
// @Param id path string true "Assignment ID"
// @Param request body models.SubmitAssignmentRequest true "Submit Assignment"
// @Success 201 {object} map[string]interface{}
...
// @Param request body models.GradeSubmissionRequest true "Grade Submission"
// @Success 200 {object} map[string]interface{}
// @Router /assignments/{id}/grade/{submission_id} [post]
